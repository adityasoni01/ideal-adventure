...
export default function Navbar(){
    return (
		<>
	<nav class="relative px-9 flex justify-between items-center bg-custom-yellow border-b-4 border-l-4 border-orange-600" id="">
		...
		<ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
			...
			<li><a class="text-lg text-gray-700 hover:text-orange-500 text font-bold font-serif" href="/experience">Experience</a></li>
			<li class="text-black">
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill" viewBox="0 0 24 24">
					<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
				</svg>
			</li>
			<li><a class="text-lg text-gray-700 hover:text-orange-500 text font-bold font-serif" href="/plan">Plan</a></li>
			<li class="text-black">
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill" viewBox="0 0 24 24">
					<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
				</svg>
		...
		<a class="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-yellow-200 hover:bg-body-color text-sm text-gray-900 font-bold  rounded-xl transition duration-200" href="/user/login">Sign In</a>
		<a class="hidden lg:inline-block py-2 px-6 bg-yellow-200 hover:bg-body-color text-sm text-gray-900 font-bold rounded-xl transition duration-200" href="/user/signup">Sign up</a>
	</nav>
		...
		<nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
			...
			<div class="mt-auto">
				<div class="pt-6">
					...
					<a class="block px-4 py-3 mb-2 leading-loose text-xs text-center text-white font-semibold bg-yellow-100 hover:bg-body-color  rounded-xl" href="#">Sign Up</a>
				</div>
			</div>
		</nav>
	</div>
