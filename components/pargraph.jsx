export default function Paragraph() {
    return (
        <>
            ...
            <div class="bg-yellow-100 border-t-2 border-orange-600 bg-cover w-full py-10 bg-no-repeat">
