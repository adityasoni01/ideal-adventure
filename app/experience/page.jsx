...
Explore
    ...
    <div class="rounded overflow-hidden shadow-lg transition duration-500 hover:scale-105">
      ...
      <div class="px-6 py-4">
        ...
        <button class="hover:bg-custom-yellow text-black font-bold  text-xl mb-2 py-2 px-4 rounded-2xl transition duration-200 hover:scale-110 border-solid" onClick={() => {setShowModal(true); setMessage({...message, title: "JAIPUR JAZZ AND BLUES FESTIVAL",des: " Raising the pedestal to the existing stature of Jazz in India, Seher conceptualized and produced the Jaipur Jazz and Blues Festival in association with UNESCO and Rajasthan Tourism – a dynamic festival that aims to open the world of Jazz and Blues to a wider audience. After a series of successful initiatives of showcasing International world music artists in Udaipur, Seher brings its first true Jazz and Blues festival at the iconic Central Park of Jaipur – a nominated World Heritage city by UNESCO"})}}>
Explore
</button> 
      </div>
    </div>
...
{/* Adventure page */}
    ...
    <h1 class="text-5xl  font-serif dark:text-white text-center pt-10" id='adv'>ADVENTURES</h1>
...
Explore
    ...
    <h1 class="text-5xl  font-serif dark:text-white text-center pt-10" id='food'>FOOD AND CUISINE</h1>
    ...
    <div class="rounded overflow-hidden shadow-lg transition duration-500 hover:scale-105">
      ...
      <div class="font-bold text-xl mb-2 ">DAAL BATI CHURMA</div>
       <button class="bg- hover:bg-custom-yellow text-black font-bold  text-xl mb-2 py-2 px-4 rounded-2xl transition duration-200 hover:scale-110 border-solid" onClick={() => {setShowModal(true); setMessage({...message, title: "BUNDI FESTIVAL",des: "The Bundi Festival is celebrated in the month of Kartik (October-November) and includes several spiritual and traditional activities. It is a remarkable cluster of traditional art, culture and craftsmanship and visitors are left charmed by its magnificence. The program includes a colourful Shobha Yatra, arts & crafts fair, ethnic sports, cultural exhibition, classical music & dance program, turban competitions, bridal clothing, musical band competitions, and a sparkling fireworks display. Early in the morning, after the full moon night of Kartik Purnima, women and men clad in attractive colourful costumes light diyas or lamps on the banks of River Chambal and seek blessings."})}}>
Explore
</button>
